...
func TestMaxSlicePositive(t *testing.T) {
	slice := []float64{
	...
	maxValue := 91.39
	myMaxValue := MaxSlice(slice)
	if maxValue != myMaxValue {
		t.Fatalf("Error in the max value is %v but MaxSlice   says : %v", maxValue, myMaxValue)
	}
}
func TestMaxMatrixPositive(t *testing.T) {
	matrix := [][]float64{
	...
	maxValue := 98.87
	myMaxValue := MaxMatrix(matrix)
	if maxValue != myMaxValue {
		t.Fatalf("Error in the max value is %v but MaxMatrix   says : %v", maxValue, myMaxValue)
	}
}
func TestMaxSliceNegative(t *testing.T) {
	slice := []float64{
...
func TestMaxMatrixNegative(t *testing.T) {
	matrix := [][]float64{
...
func TestMaxSliceEmpty(t *testing.T) {
	slice := []float64{}
...
func TestMaxMatrixEmpty(t *testing.T) {
	matrix := [][]float64{}
...
func TestMaxSliceBoth(t *testing.T) {
	slice := []float64{
...
func TestMaxMatrixBoth(t *testing.T) {
	matrix := [][]float64{
